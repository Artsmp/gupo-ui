...
function setDevtoolsHook(hook, target) {
  ...
  if (devtools) {
    ...
    !((_b = (_a2 = window.navigator) === null || _a2 === void 0 ? void 0 : _a2.userAgent) ===
      null || _b === void 0
      ? void 0
      : _b.includes('jsdom'))
  ) {
  ...
  try {
    if (vnode.shapeFlag & 4) {
      ...
      result = normalizeVNode(
        render2.call(proxyToUse, proxyToUse, renderCache, props, setupState, data, ctx)
      )
...
function watchPostEffect(effect2, options) {
  return doWatch(
    effect2,
    null,
    true ? Object.assign(Object.assign({}, options), { flush: 'post' }) : { flush: 'post' }
  )
}
function watchSyncEffect(effect2, options) {
  return doWatch(
    effect2,
    null,
    true ? Object.assign(Object.assign({}, options), { flush: 'sync' }) : { flush: 'sync' }
  )
}
...
function doWatch(source, cb, { immediate, deep, flush, onTrack, onTrigger } = EMPTY_OBJ) {
  ...
  const instance =
    getCurrentScope() ===
    (currentInstance === null || currentInstance === void 0 ? void 0 : currentInstance.scope)
      ? currentInstance
      : null
  let getter
